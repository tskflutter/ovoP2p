...
import 'package:ovolutter/app/components/buttons/custom_round_border_shape.dart';
            ...
            Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: widget.isNoInternet? Lottie.asset(MyImages.noInternet,height:  MediaQuery.of(context).size.height*widget.imageHeight,width: MediaQuery.of(context).size.width*.6,):CustomSvgPicture(image:widget.image,height: 100,width: 100,color: MyColor.getBorderColor(),),
                ),
                Center(
                    child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      widget.isNoInternet? const SizedBox() : Text(widget.message2,style: regularDefault.copyWith(color: MyColor.getBodyTextColor(), fontSize: Dimensions.fontLarge),textAlign: TextAlign.center,),
                      widget.isNoInternet? const SizedBox(height: 15,): const SizedBox(),
                      widget.isNoInternet?InkWell(onTap: ()async{
                        if(await Connectivity().checkConnectivity() != ConnectivityResult.none){
                          widget.onChanged!(true);
                        }
                      }, child: RoundedBorderContainer(text: MyStrings.retry.tr, bgColor: MyColor.getErrorColor(),borderColor: MyColor.getErrorColor(),textColor: MyColor.white)): const SizedBox()
                    ],
                  ),
                )),
              ],
