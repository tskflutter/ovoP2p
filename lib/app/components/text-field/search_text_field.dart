  ...
  @override
    ...
    TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        border: OutlineInputBorder(borderSide: BorderSide(color: MyColor.getBorderColor()), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
        focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: MyColor.getBorderColor()), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
        enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: MyColor.getBorderColor()), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
        suffixIcon: widget.isShowSuffixIcon
            ? widget.isPassword
            ? IconButton(
            icon: Icon(obscureText ? Icons.visibility_off : Icons.visibility, color: MyColor.getBodyTextColor(), size: 20),
            onPressed: _toggle)
            : widget.isIcon
            ? IconButton(
