    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: MyColor.getTransparentColor(), border: Border.all(color: isFocus ? MyColor.getBorderColor() : MyColor.getBorderColor(), width: 0.5), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(color: MyColor.getBodyTextColor().withOpacity(0.22), borderRadius: BorderRadius.circular(5)),
